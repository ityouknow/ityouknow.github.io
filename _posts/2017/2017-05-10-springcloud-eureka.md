...
服务中心又称注册中心，管理各种服务功能包括服务的注册、发现、熔断、负载、降级等功能，比如dubbo admin后台的各种功能。
...
由于各种服务都注册到了服务中心，就有了去做很多高级功能条件。比如几台服务提供相同服务来做均衡负载；监控服务器调用时间成功率，熔断，如果监控到某台服务器挂掉，在服务列表中移除；对不同的服务器设置不同的权重等等。

在说Eureka之前我先八卦一下Netflix
...
我第一次看到这个单词的时候，是在各种美剧或者电影的开通，Netflix拍摄的代表性的美剧有《纸牌屋》、《毒枭》、《怪奇物语》。后来研究springcloud的时候发现了Netflix公司，我就在想他们是不是同一家公司，经过核对github上面邮件后缀判定确实是同一家公司，其实springcloud的微服务就基于Netflix公司的开源产品来做的。
...
spring cloud已经帮我实现了服务中心，我们只需要很简单的几个步骤就可以完成。
