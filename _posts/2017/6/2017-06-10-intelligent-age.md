...
我们对大数据重要性的认识不应该停留在统计、改进产品和销售，或者提供决策支持上，而是应该看到它（和摩尔定律、数学模型一起）导致了机器智能的产生。而机器一旦产生和人类类似的智能，就将对人类社会产生重大影响。毫不夸张的说，决定今后20年经济发展的是大数据和由之而来的智能革命。
