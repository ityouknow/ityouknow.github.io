...
上篇文章[Docker(四)：Docker 三剑客之 Docker Compose ](http://www.ityouknow.com/docker/2018/03/12/docker-use-dockerfile.html)介绍了 Docker Compose，这篇文章我们来了解 Docker Machine 。
