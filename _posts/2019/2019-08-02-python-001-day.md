...
Windows x86 选择下载 ：[Windows x86 embeddable zip file](https://www.python.org/ftp/python/3.7.4/python-3.7.4.exe)	
...
利用 homebrew 安装 Python，直接终端中输入以下命令：
...
参考 ：https://zh.wikipedia.org/wiki/Python